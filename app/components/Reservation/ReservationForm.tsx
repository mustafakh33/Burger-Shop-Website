...
const ReservationForm = () => {
  ...
  <div className="mt-[2rem]">
    <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 items-center w-[80%] mx-auto justify-between lg:justify-center xl:justify-between space-x-4">
      <select
      ...
      <input
        type="date"
        className="px-10 lg:px-5 xl:px-10 py-2.5 bg-transparent rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100"
      />
    </div>
    <input
      type="time"
